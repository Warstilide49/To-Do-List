...
/* harmony export */   "createTaskBoard": () => (/* binding */ createTaskBoard),
/* harmony export */   "createProjectDOM": () => (/* binding */ createProjectDOM),
/* harmony export */   "createTaskDOM": () => (/* binding */ createTaskDOM),
/* harmony export */   "createModal": () => (/* binding */ createModal)
/* harmony export */ });
/* harmony import */ var _app_layer_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);
/* harmony import */ var _event_listeners_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3);



function loadHome(){
	const content=document.getElementById("content");
	initialize(content, _app_layer_js__WEBPACK_IMPORTED_MODULE_0__.projects);
}
...
function createSidebar(projects){
	...
	add_project_button.addEventListener("click", _event_listeners_js__WEBPACK_IMPORTED_MODULE_1__.addProject);
...
function createTaskBoard(tasks, headerTitle="Default"){
	...
	add_task_button.addEventListener("click", _event_listeners_js__WEBPACK_IMPORTED_MODULE_1__.addTask);
...
function createProjectDOM(title, checker=false){  //checker=1 is for the default project,cos we dont want cancel button there.
	let project=document.createElement("div");
	project.classList.add("project");

	project.addEventListener("click", _event_listeners_js__WEBPACK_IMPORTED_MODULE_1__.changeTaskBoard);
	...
	project.addEventListener("mouseover", _event_listeners_js__WEBPACK_IMPORTED_MODULE_1__.showX);
	project.addEventListener("mouseout", _event_listeners_js__WEBPACK_IMPORTED_MODULE_1__.hideX); 

	let cancelButton=document.createElement("div");
	cancelButton.textContent="x";
	cancelButton.classList.add("cancelButton");
	cancelButton.addEventListener("click", _event_listeners_js__WEBPACK_IMPORTED_MODULE_1__.removeProject);
...
function createTaskDOM(titleArg, descriptionArg, deadlineArg, state){
	...
	deleteButton.addEventListener("click", _event_listeners_js__WEBPACK_IMPORTED_MODULE_1__.removeTask);

	let checkerButton=task.querySelector('.checker_button');
	checkerButton.addEventListener("click", _event_listeners_js__WEBPACK_IMPORTED_MODULE_1__.changeState)

	let editButton=task.querySelector('.edit_task');
	editButton.addEventListener("click", _event_listeners_js__WEBPACK_IMPORTED_MODULE_1__.editTask);
...
/* harmony export */   "getProjectUsingTitle": () => (/* binding */ getProjectUsingTitle),
/* harmony export */   "createTaskObject": () => (/* binding */ createTaskObject),
/* harmony export */   "removeTaskObject": () => (/* binding */ removeTaskObject),
/* harmony export */   "editTaskObject": () => (/* binding */ editTaskObject),
/* harmony export */   "getTaskFromTitle": () => (/* binding */ getTaskFromTitle),
...
function getProjectUsingTitle(title) {
	for(let i=0;i<projects.length; i++){
...
function createTaskObject(title,description,deadline, state=0){
	return {title, description, deadline, state};
}

function removeTaskObject(projectTitle, taskTitle){
...
/* harmony export */   "changeTaskBoard": () => (/* binding */ changeTaskBoard),
/* harmony export */   "showX": () => (/* binding */ showX),
/* harmony export */   "hideX": () => (/* binding */ hideX),
/* harmony export */   "removeProject": () => (/* binding */ removeProject),
...
/* harmony import */ var _app_layer_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2);
...
function addProject(e){
	...
	let {container, modal}=(0,_DOM_js__WEBPACK_IMPORTED_MODULE_0__.createModal)("15vw","20vh","add_project");
	...
	submit.addEventListener("click", ()=>{
		...
		if (!duplicate && title){
			let element=(0,_DOM_js__WEBPACK_IMPORTED_MODULE_0__.createProjectDOM)(title);
			...
			_app_layer_js__WEBPACK_IMPORTED_MODULE_1__.createNewProject(title);
...
function isDuplicateProject(title){							//Will implement binary search if I ever have a lot of projects, for now this will work xD
	for (let i=0; i<_app_layer_js__WEBPACK_IMPORTED_MODULE_1__.projects.length; i+=1){
		if (title==_app_layer_js__WEBPACK_IMPORTED_MODULE_1__.projects[i].title){
			return true;
		}
	}
	return false
...
function addTask(e){
	let {container, modal}=(0,_DOM_js__WEBPACK_IMPORTED_MODULE_0__.createModal)("20vw","35vh","add_task");
	let body=document.body;
	body.appendChild(container);

	let today=(0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(),"yyyy-MM-dd");
	...
	let currentProject=_app_layer_js__WEBPACK_IMPORTED_MODULE_1__.getProjectUsingTitle(currentProjectTitle)
	...
	submit.addEventListener("click", ()=>{
		...
		let element=(0,_DOM_js__WEBPACK_IMPORTED_MODULE_0__.createTaskDOM)(title,description,deadline);
		e.target.parentNode.childNodes[1].appendChild(element);		//RELATION from button to taskboard

		let task= _app_layer_js__WEBPACK_IMPORTED_MODULE_1__.createTaskObject(title, description, deadline);
		_app_layer_js__WEBPACK_IMPORTED_MODULE_1__.addTaskToProject(currentProject, task);
		localStorage.setItem("projects",JSON.stringify(_app_layer_js__WEBPACK_IMPORTED_MODULE_1__.projects));
...
function removeProject(e){
	...
	submit.addEventListener("click", ()=>{
		...
		_app_layer_js__WEBPACK_IMPORTED_MODULE_1__.removeProject(title);
		localStorage.setItem("projects",JSON.stringify(_app_layer_js__WEBPACK_IMPORTED_MODULE_1__.projects));
...
function editTask(e){
	...
	let {container, modal}=(0,_DOM_js__WEBPACK_IMPORTED_MODULE_0__.createModal)("20vw","35vh","edit");
	let body=document.body;
	body.appendChild(container);
...
function removeTask(e){
	...
	submit.addEventListener("click", ()=>{
		_app_layer_js__WEBPACK_IMPORTED_MODULE_1__.removeTaskObject(currentProjectTitle, title)
		localStorage.setItem("projects",JSON.stringify(_app_layer_js__WEBPACK_IMPORTED_MODULE_1__.projects));
...
function changeState(e){
	...
	let task = _app_layer_js__WEBPACK_IMPORTED_MODULE_1__.getTaskFromTitle(currentProjectTitle, taskTitle);
...
function confirmationModal(){
	let {container, modal}=(0,_DOM_js__WEBPACK_IMPORTED_MODULE_0__.createModal)("30vw","20vh","confirmation");
	let body=document.body;
	body.appendChild(container);
...
function displayReplace(title){
	...
	container.appendChild( (0,_DOM_js__WEBPACK_IMPORTED_MODULE_0__.createTaskBoard)( _app_layer_js__WEBPACK_IMPORTED_MODULE_1__.getProjectUsingTitle(title).tasks, currentProjectTitle) )
}
...
/* harmony export */ });
/* harmony import */ var _isDate_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(19);
...
/* harmony export */ });
/* harmony import */ var _constants_index_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(38);
/* harmony import */ var _lib_requiredArgs_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5);
/* harmony import */ var _lib_toInteger_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(16);
...
(() => {
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_DOM_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);


document.addEventListener('DOMContentLoaded', _modules_DOM_js__WEBPACK_IMPORTED_MODULE_0__.loadHome);
})();
